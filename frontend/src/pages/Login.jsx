  ...
  const { values, handleSubmit, handleChange, isValid, resetForm } = useFormik({
    ...
    onSubmit: values => {
      ...
      LogIn(values.email, values.password)
        .then((result) => {
          console.log('Login result:', result); // Add this line for logging
          if (result.data.currentUser) {
            console.log('User successfully logged in.'); // Add this line for logging
            ...
            console.log('Wrong email or password.'); // Add this line for logging
            resetForm();
            toast({
              title: 'Error!',
